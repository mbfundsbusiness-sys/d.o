...
export function LanguageStats({ sessions }: { sessions: LanguageSession[] }) {
  ...
  // This week's total minutes (last 7 days from today)
  const now = new Date();
  ...
  const stats = [
    ...
    },
    {
      ...
      unit: languages.size === 1 ? 'language' : 'languages',
      icon: CalendarDays,
      tone: 'text-success',
    },
  ];
